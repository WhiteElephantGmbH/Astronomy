...
package body Serial_Io.Windows is
...
------------------------------------------------------------------------------------------------------------------------
  ...
  function Baudrate_Id (Value : Win32.DWORD) return Baudrate is
  begin
    case Value is
    when Win32.Winbase.CBR_110    => return B110;
    when Win32.Winbase.CBR_300    => return B300;
    when Win32.Winbase.CBR_600    => return B600;
    when Win32.Winbase.CBR_1200   => return B1200;
    when Win32.Winbase.CBR_2400   => return B2400;
    when Win32.Winbase.CBR_4800   => return B4800;
    when Win32.Winbase.CBR_9600   => return B9600;
    when Win32.Winbase.CBR_14400  => return B14400;
    when Win32.Winbase.CBR_19200  => return B19200;
    when Win32.Winbase.CBR_38400  => return B38400;
    when Win32.Winbase.CBR_57600  => return B57600;
    when Win32.Winbase.CBR_115200 => return B115200;
    when others =>
  ...
  function Baudrate_Value (Id : Baudrate) return Win32.DWORD is
  begin
    case Id is
    when B110    => return Win32.Winbase.CBR_110;
    when B300    => return Win32.Winbase.CBR_300;
    when B600    => return Win32.Winbase.CBR_600;
    when B1200   => return Win32.Winbase.CBR_1200;
    when B2400   => return Win32.Winbase.CBR_2400;
    when B4800   => return Win32.Winbase.CBR_4800;
    when B9600   => return Win32.Winbase.CBR_9600;
    when B14400  => return Win32.Winbase.CBR_14400;
    when B19200  => return Win32.Winbase.CBR_19200;
    when B38400  => return Win32.Winbase.CBR_38400;
    when B57600  => return Win32.Winbase.CBR_57600;
    when B115200 => return Win32.Winbase.CBR_115200;
    end case;
  end Baudrate_Value;
...
------------------------------------------------------------------------------------------------------------------------
  ...
  type Data_Pointers is array (Port) of Channel_Data_Pointer;
  ...
  procedure Create (The_Channel : Channel) is
    ...
    begin
      return Win32.Winbase.DCB'(DCBLENGTH         => Win32.Winbase.DCB'size / 8,
                                BaudRate          => Baudrate_Value (Default_Baudrate),
  ...
  begin
    The_Channel.The_Data.all := Channel_Data'(The_Device           => New_Device (The_Channel.The_Port),
  ...
  procedure Close (The_Data : Channel_Data_Pointer) is
  begin
  ...
  protected body Port_Allocator is
    ...
    begin
      The_Channel.The_Data := new Channel_Data;
    ...
    procedure Release (The_Port : Port) is
      procedure Dispose is new Ada.Unchecked_Deallocation (Channel_Data, Channel_Data_Pointer);
    begin
      if The_Data (The_Port) /= null then
  ...
  begin
    DCB.BaudRate := Baudrate_Value (The_Baudrate);
  ...
  begin
    return Baudrate_Id (The_Channel.The_Data.The_Control_Block.BaudRate);
  end Baudrate_Of;
