...
package body Gpiod_Interface is
  ...
  -- Dummy handles --
  -------------------
  The_Chip              : aliased Chip;
  The_Edge_Event        : aliased Edge_Event;
  The_Edge_Event_Buffer : aliased Edge_Event_Buffer;
  The_Line_Config       : aliased Line_Config;
  The_Line_Settings     : aliased Line_Settings;
  The_Line_Request      : aliased Line_Request;
  The_Request_Config    : aliased Request_Config;
  ...
  begin
    return The_Line_Request'access;
  end Request_Lines;
  ...
  begin
    return The_Line_Settings'access;
  ...
  -- Edge Event --
  ----------------
  The_Expected_Edge : Edge_Event_Type;

  function Rising_Edge return Edge_Event_Type is
  begin
    The_Expected_Edge := Rising_Edge_Value;
    CI.Set (CI.Rising);
    return The_Expected_Edge;
  end Rising_Edge;


  function Falling_Edge return Edge_Event_Type is
  begin
    The_Expected_Edge := Falling_Edge_Value;
    CI.Set (CI.Falling);
    return The_Expected_Edge;
  end Falling_Edge;
  ...
  begin
    return The_Edge_Event_Buffer'access;
  ...
  begin
    return The_Request_Config'access;
