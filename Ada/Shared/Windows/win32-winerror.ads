...
package Win32.Winerror is
   ...
   NTE_BAD_UID                             : constant := 16#80090001#;
   NTE_BAD_HASH                            : constant := 16#80090002#;
   NTE_BAD_KEY                             : constant := 16#80090003#;
   NTE_BAD_LEN                             : constant := 16#80090004#;
   NTE_BAD_DATA                            : constant := 16#80090005#;
   NTE_BAD_SIGNATURE                       : constant := 16#80090006#;
   NTE_BAD_VER                             : constant := 16#80090007#;
   NTE_BAD_ALGID                           : constant := 16#80090008#;
   NTE_BAD_FLAGS                           : constant := 16#80090009#;
   NTE_BAD_TYPE                            : constant := 16#8009000A#;
   NTE_BAD_KEY_STATE                       : constant := 16#8009000B#;
   NTE_BAD_HASH_STATE                      : constant := 16#8009000C#;
   NTE_NO_KEY                              : constant := 16#8009000D#;
   NTE_NO_MEMORY                           : constant := 16#8009000E#;
   NTE_EXISTS                              : constant := 16#8009000F#;
   NTE_PERM                                : constant := 16#80090010#;
   NTE_NOT_FOUND                           : constant := 16#80090011#;
   NTE_DOUBLE_ENCRYPT                      : constant := 16#80090012#;
   NTE_BAD_PROVIDER                        : constant := 16#80090013#;
   NTE_BAD_PROV_TYPE                       : constant := 16#80090014#;
   NTE_BAD_PUBLIC_KEY                      : constant := 16#80090015#;
   NTE_BAD_KEYSET                          : constant := 16#80090016#;
   NTE_PROV_TYPE_NOT_DEF                   : constant := 16#80090017#;
   NTE_PROV_TYPE_ENTRY_BAD                 : constant := 16#80090018#;
   NTE_KEYSET_NOT_DEF                      : constant := 16#80090019#;
   NTE_KEYSET_ENTRY_BAD                    : constant := 16#8009001A#;
   NTE_PROV_TYPE_NO_MATCH                  : constant := 16#8009001B#;
   NTE_SIGNATURE_FILE_BAD                  : constant := 16#8009001C#;
   NTE_PROVIDER_DLL_FAIL                   : constant := 16#8009001D#;
   NTE_PROV_DLL_NOT_FOUND                  : constant := 16#8009001E#;
   NTE_BAD_KEYSET_PARAM                    : constant := 16#8009001F#;
   NTE_FAIL                                : constant := 16#80090020#;
   NTE_SYS_ERR                             : constant := 16#80090021#;
   NTE_SILENT_CONTEXT                      : constant := 16#80090022#;
   NTE_TOKEN_KEYSET_STORAGE_FULL           : constant := 16#80090023#;
   NTE_TEMPORARY_PROFILE                   : constant := 16#80090024#;
   NTE_FIXEDPARAMETER                      : constant := 16#80090025#;
