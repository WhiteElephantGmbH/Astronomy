...
package Database is
  ...
  type Feature_Size is delta Delta_Size range 0.0 .. 1500.0 - Delta_Size with Small => Delta_Size; -- in kilometers

  type Moon_Feature_Type is (Swirl,        -- Mondwirbel (Albedo Feature: Reiner Gamma)
                             Catena,       -- Mondkraterkette
                             Crater,       -- Mondkrater
                             Lacus,        -- Mondsee
                             Mare,         -- Mondmeer
                             Mons,         -- Mondberg
                             Palus,        -- Mondsumpf (Palus Somni)
                             Promontorium, -- Mondvorgebirge
                             Rima,         -- Mondspalte
                             Rupes,        -- Mondklippen
                             Sinus,        -- Mondbucht (Sinus Iridum = Regenbogenbucht)
                             Vallis);      -- Mondtal
