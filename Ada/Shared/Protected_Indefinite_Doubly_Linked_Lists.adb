...
package body Protected_Indefinite_Doubly_Linked_Lists is

  package List is new Indefinite_Doubly_Linked_Lists (Element);
  The_Event_List : List.Item;

  protected Control is
    entry Await_Event;
    function Next_Event return Element;
  ...
  begin
    Control.Await_Event;
    declare
      Result : constant Element := Control.Next_Event;
    begin
      Control.Remove_Event;
      return Result;
    end;
  end Next;
  ...
  protected body Control is
    ...
    entry Await_Event when Event_Available is
    begin
      Is_Locked := True;
      Event_Available := False;
    end Await_Event;

    function Next_Event return Element is
    begin
      return List.First_Element (The_Event_List);
    end Next_Event;

    procedure Remove_Event is
    begin
      List.Delete_First (The_Event_List);
...
end Protected_Indefinite_Doubly_Linked_Lists;
