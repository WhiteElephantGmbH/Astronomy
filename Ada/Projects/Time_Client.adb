...
package body Time_Client is
  ...
  begin
    ...
    The_Information.Clock.Is_Set := Clock_Set.Get;
    The_Information.Clock.Is_Set_From_Pc := Clock_Set_From_Pc.Get;
    The_Information.Clock.Is_Synchronized := Clock_Synchronized.Get;
    The_Information.Mount.Is_Connected := Mount_Connected.Get;
    The_Information.Mount.Is_Synchronized := Mount_Synchronized.Get;
